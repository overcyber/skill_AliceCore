...
module.exports = function(RED) {
    ...
    function AliceMQTTBrokerNode(n) {
        ...
        this.port = n.port;
        this.clientid = 'ProjectAliceInterface';
        ...
        if (this.brokerurl === "") {
            ...
            if (this.broker.indexOf("://") > -1) {
                ...
                if (this.broker !== "") {
                    ...
                    this.brokerurl = this.brokerurl+"127.0.0.1:1883";
                }
            }
        }
    ...
    RED.nodes.registerType("alice-mqtt-broker", AliceMQTTBrokerNode, {
        credentials: {
            user: {type:"text"}, 
